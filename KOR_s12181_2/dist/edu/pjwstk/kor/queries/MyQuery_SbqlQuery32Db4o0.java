...
public class MyQuery_SbqlQuery32Db4o0 implements Db4oSBQLQuery<java.lang.Double> {
    public MyQuery_SbqlQuery32Db4o0() {
    }
    ...
    public java.lang.Double executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id44 : _ids44) {
            ...
            _ident_Payment.add((edu.pjwstk.kor.model.Payment) _ref44.getObject());
        }
        ...
        for (long _id45 : _ids45) {
            ...
            _ident_Payment1.add((edu.pjwstk.kor.model.Payment) _ref45.getObject());
        }
        ...
        for (long _id46 : _ids46) {
            ...
            _ident_Payment2.add((edu.pjwstk.kor.model.Payment) _ref46.getObject());
        }
