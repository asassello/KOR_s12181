...
public class MyQuery_SbqlQuery20Db4o0 implements Db4oSBQLQuery<java.lang.Double> {
    public MyQuery_SbqlQuery20Db4o0() {
    }
    ...
    public java.lang.Double executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id31 : _ids31) {
            ...
            _ident_Shipment.add((edu.pjwstk.kor.model.Shipment) _ref31.getObject());
        }
        ...
        if ((_dotResult != null) && !_dotResult.isEmpty()) {
            ...
            for (Number _avgEl3 : _dotResult) {
                _avgSum3 = MathUtils.sum(_avgSum3, _avgEl3);
            }

            _avgResult = _avgSum3.doubleValue() / _dotResult.size();
        }
