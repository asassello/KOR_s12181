...
public class MyQuery_SbqlQuery25Db4o0 implements Db4oSBQLQuery<java.lang.Double> {
    public MyQuery_SbqlQuery25Db4o0() {
    }
    ...
    public java.lang.Double executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id36 : _ids36) {
            ...
            _ident_Shipment.add((edu.pjwstk.kor.model.Shipment) _ref36.getObject());
        }
