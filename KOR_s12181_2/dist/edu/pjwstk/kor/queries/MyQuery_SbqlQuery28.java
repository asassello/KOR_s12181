...
public class MyQuery_SbqlQuery28 {
    private com.db4o.ObjectContainer dataBase;

    public MyQuery_SbqlQuery28(final com.db4o.ObjectContainer dataBase) {
    ...
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<edu.pjwstk.kor.model.Employee> _dotResult1 = _ident_dataBase.query(new MyQuery_SbqlQuery28Db4o0());
