...
public class MyQuery_SbqlQuery36Db4o0 implements Db4oSBQLQuery<java.lang.Integer> {
    public MyQuery_SbqlQuery36Db4o0() {
    }

    /**
     * query='dataBase.( count((Receiver.getCity() as rc where rc == "Lodz")))'
    '
     **/
    public java.lang.Integer executeQuery(final ObjectContainerBase ocb,
        final Transaction t) {
        //evaluateExpression - start  count((Receiver.getCity() as rc where rc == "Lodz"))
        final LocalTransaction transLocal = (LocalTransaction) t;

        //visitUnaryExpression - start  count((Receiver.getCity() as rc where rc == "Lodz"))
        //visitWhereExpression - start Receiver.getCity() as rc where rc == "Lodz"
        ...
        for (long _id53 : _ids53) {
            ...
            _ident_Receiver.add((edu.pjwstk.kor.model.Receiver) _ref53.getObject());
        }
        ...
        for (java.lang.String _whereEl : _asResult_rc) {
            ...
            //visitBinaryAExpression - start rc == "Lodz"
            ...
            //visitLiteralExpression - start "Lodz"
            //visitLiteralExpression - end "Lodz"
            //OperatorEquals - start rc == "Lodz"
            java.lang.Boolean _equalsResult = OperatorUtils.equalsSafe(_ident_rc,
                    "Lodz");

            //OperatorEquals - end rc == "Lodz"
            //visitBinaryAExpression - end rc == "Lodz"
            if (_equalsResult) {
        ...
        //visitWhereExpression - end Receiver.getCity() as rc where rc == "Lodz"
        //OperatorCount - start  count((Receiver.getCity() as rc where rc == "Lodz"))
        java.lang.Integer _countResult = _whereResult.size();
        //OperatorCount - end  count((Receiver.getCity() as rc where rc == "Lodz"))
        //visitUnaryExpression - end  count((Receiver.getCity() as rc where rc == "Lodz"))
        pl.wcislo.sbql4j.db4o.utils.DerefUtils.activateResult(_countResult, ocb);

        return _countResult;

        //evaluateExpression - end  count((Receiver.getCity() as rc where rc == "Lodz"))
    }
}
