...
public class MyQuery_SbqlQuery6Db4o0 implements Db4oSBQLQuery<java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct>> {
    public MyQuery_SbqlQuery6Db4o0() {
    }
    ...
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id7 : _ids7) {
            ...
            _ident_Receiver.add((edu.pjwstk.kor.model.Receiver) _ref7.getObject());
        }
        ...
        for (long _id8 : _ids8) {
            ...
            _ident_Sender.add((edu.pjwstk.kor.model.Sender) _ref8.getObject());
        }
        ...
        for (long _id9 : _ids9) {
            ...
            _ident_Shipment.add((edu.pjwstk.kor.model.Shipment) _ref9.getObject());
        }
