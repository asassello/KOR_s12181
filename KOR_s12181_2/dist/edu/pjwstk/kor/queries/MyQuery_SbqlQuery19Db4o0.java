...
public class MyQuery_SbqlQuery19Db4o0 implements Db4oSBQLQuery<java.lang.Integer> {
    public MyQuery_SbqlQuery19Db4o0() {
    }
    ...
    public java.lang.Integer executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id30 : _ids30) {
            ...
            _ident_Shipment.add((edu.pjwstk.kor.model.Shipment) _ref30.getObject());
        }
