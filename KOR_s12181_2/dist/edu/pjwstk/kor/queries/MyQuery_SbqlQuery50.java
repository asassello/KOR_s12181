...
public class MyQuery_SbqlQuery50 {
    private com.db4o.ObjectContainer dataBase;

    public MyQuery_SbqlQuery50(final com.db4o.ObjectContainer dataBase) {
    ...
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _queryResult = _ident_dataBase.query(new MyQuery_SbqlQuery50Db4o0());
