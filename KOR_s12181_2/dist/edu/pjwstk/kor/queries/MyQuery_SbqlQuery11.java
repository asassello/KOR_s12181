...
public class MyQuery_SbqlQuery11 {
    private com.db4o.ObjectContainer dataBase;
    private java.lang.Integer param;

    public MyQuery_SbqlQuery11(final com.db4o.ObjectContainer dataBase,
    ...
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<edu.pjwstk.kor.model.Employee> _dotResult1 = _ident_dataBase.query(new MyQuery_SbqlQuery11Db4o0(
                    param));
