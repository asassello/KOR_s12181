...
public class MyQuery_SbqlQuery34Db4o0 implements Db4oSBQLQuery<java.util.Collection<edu.pjwstk.kor.model.Receiver>> {
    ...
    public java.util.Collection<edu.pjwstk.kor.model.Receiver> executeQuery(
        ...
        for (long _id48 : _ids48) {
            ...
            _ident_Receiver.add((edu.pjwstk.kor.model.Receiver) _ref48.getObject());
        }
