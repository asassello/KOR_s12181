...
public class MyQuery_SbqlQuery34Db4o0 implements Db4oSBQLQuery<java.lang.Double> {
    public MyQuery_SbqlQuery34Db4o0() {
    }
    ...
    public java.lang.Double executeQuery(final ObjectContainerBase ocb,
        ...
        for (edu.pjwstk.kor.model.Shipment _dotEl : _ident_Shipment) {
            ...
            for (long _id50 : _ids50) {
                ...
                _ident_Packagement.add((edu.pjwstk.kor.model.Packagement) _ref50.getObject());
            }
        ...
        for (edu.pjwstk.kor.model.Packagement _dotEl1 : _dotResult) {
            ...
            for (long _id51 : _ids51) {
                ...
                _ident_PaymentType.add((edu.pjwstk.kor.model.PaymentType) _ref51.getObject());
            }
