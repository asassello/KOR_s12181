...
public class MyQuery_SbqlQuery31Db4o0 implements Db4oSBQLQuery<java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct>> {
    ...
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id43 : _ids43) {
            ...
            _ident_Receiver.add((edu.pjwstk.kor.model.Receiver) _ref43.getObject());
        }
        ...
        for (long _id44 : _ids44) {
            ...
            _ident_Sender.add((edu.pjwstk.kor.model.Sender) _ref44.getObject());
        }
        ...
        for (long _id45 : _ids45) {
            ...
            _ident_Shipment.add((edu.pjwstk.kor.model.Shipment) _ref45.getObject());
        }
